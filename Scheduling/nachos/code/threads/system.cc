...
//added now
unsigned long g_totalTime;
unsigned long g_totalWait;
unsigned long g_totalBursts;
unsigned long g_totalWaits;
unsigned int g_mincpuburst = 4000;
unsigned int g_maxcpuburst = 0;
unsigned int g_avgcpuburst =0;
unsigned int g_varcpuburst =0 ;
unsigned long g_minthreadcom = 400000;
unsigned long g_maxthreadcom = 0;
unsigned long g_avgthreadcom =0 ;
unsigned long g_varthreadcom = 0 ;
unsigned long g_squarethreadcom =0 ;
...
TimerInterruptHandler(int dummy)
{
    ...
    if (interrupt->getStatus() != IdleMode) {
        ...
        if( algorithm>2 ){
            int n_start = currentThread->burstStartTime;
            int n_time = stats->totalTicks;
            int currentBurstTime = n_time - n_start;
            if(currentBurstTime>quantum){
